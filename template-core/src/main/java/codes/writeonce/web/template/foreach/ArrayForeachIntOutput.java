...
public class ArrayForeachIntOutput extends AbstractArrayForeachOutput {

    public ArrayForeachIntOutput(int fromIndex, ObjectEvaluator[] evaluators, int toIndex, Output output) {
