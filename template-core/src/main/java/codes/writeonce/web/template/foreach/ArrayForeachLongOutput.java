...
public class ArrayForeachLongOutput extends AbstractArrayForeachOutput {

    public ArrayForeachLongOutput(int fromIndex, ObjectEvaluator[] evaluators, int toIndex, Output output) {
