...
public class ArrayForeachDoubleOutput extends AbstractArrayForeachOutput {

    public ArrayForeachDoubleOutput(int fromIndex, ObjectEvaluator[] evaluators, int toIndex, Output output) {
