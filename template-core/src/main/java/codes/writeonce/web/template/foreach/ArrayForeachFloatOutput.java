...
public class ArrayForeachFloatOutput extends AbstractArrayForeachOutput {

    public ArrayForeachFloatOutput(int fromIndex, ObjectEvaluator[] evaluators, int toIndex, Output output) {
