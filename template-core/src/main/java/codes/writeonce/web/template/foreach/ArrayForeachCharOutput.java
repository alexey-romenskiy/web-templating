...
public class ArrayForeachCharOutput extends AbstractArrayForeachOutput {

    public ArrayForeachCharOutput(int fromIndex, ObjectEvaluator[] evaluators, int toIndex, Output output) {
