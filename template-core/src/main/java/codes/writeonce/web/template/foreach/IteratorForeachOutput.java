...
public class IteratorForeachOutput extends AbstractForeachOutput {

    private final Setter setter;
    private final Output output;

    public IteratorForeachOutput(int fromIndex, ObjectEvaluator[] evaluators, Setter setter, Output output) {
